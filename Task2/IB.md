...
В чек-лист включены следующие разделы:
...
*   некоторые контракты API предоставяют избыточный доступ  

**Безопасность данных**

*   есть прецеденты многократной регистрации пользователей
*   есть подозрения на предоставление персональной информации партнерам, что может повлечь проблемы с законодательством
*   нет контроля за внутренними потоками данных, вследствие чего отсутсвует гарантия их целостности и качества  
     

**Инфраструктура**

*   в компании используется гибридная инфраструктура, но из-за смены одного из руководителей контроль за ее работоспособностью мог быть остановлен
*   есть бэкапы, но отсутсвует контроль их целостности и DRP

**Управление инцидентами**

*   Произошедший инцидент с утечкой данных у конкурентов
...
| **III.1 Локальная инфраструктура** |   |   |   |
...
| 13 | Контролируется ли оборудование на всем жизненном цикле: покупка, настройка, мониторинг состояния и безопасная утилизация? |   |   |
| **III.2 Облачная инфраструктура** |   |   |   |
| 14 | Настроены ли политики управления доступом к облачным ресурсам? |   |   |
| 15 | Используются ли автоматизированные инструменты безопасности от провайдера облачных услуг для выявления и устранения уязвимостей? |   |   |
| 16 | Настроены ли политики автоматического резервного копирования в облачной среде и контролируется ли доступ к этим копиям? |   |   |
| 17 | Включена ли многофакторная аутентификация для доступа к облачным сервисам и административным консолям? |   |   |
| 18 | Используются ли теги и политики для идентификации и управления ресурсами в облаке? |   |   |
| 19 | Включена ли сегментация доступа к различным компонентам облачной инфраструктуры? |   |   |
| 20 | Используются ли специальные инструменты для сканирования конфигураций на соответствие рекомендациям безопасности? |   |   |
